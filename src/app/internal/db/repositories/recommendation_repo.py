...
from app.internal.domain.entities.menu_entities import MenuOut, Filters, RecommendationOnDay, RecommendationFilter
from app.internal.domain.entities.product_entities import ProductOut
from app.internal.domain.services.recomendation_services import IRecommendationRepository
